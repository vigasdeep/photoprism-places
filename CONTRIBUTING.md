...
[easy](https://github.com/photoprism/photoprism-places/labels/easy) can be good (first) contributions.
...
You are welcome to add specific feature requests directly to our [GitHub issue tracker](https://github.com/photoprism/photoprism-places/issues)
if no similar [idea](https://github.com/photoprism/photoprism-places/labels/idea)
or [todo](https://github.com/photoprism/photoprism-places/labels/todo) already exists.
...
Please use the [GitHub issue tracker](https://github.com/photoprism/photoprism-places/issues) to report clearly identified bugs and impediments to us.
